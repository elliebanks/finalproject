    ...
    return (
        <>
            ...
            <div className="container mb-3">
                <img src="https://media.discordapp.net/attachments/870731172664188979/872184821533798491/phree-fromSkratch-logo.jpg" className="img-fluid" alt="from-skratch-logo" id="aboutPageLogo" />
            </div>
