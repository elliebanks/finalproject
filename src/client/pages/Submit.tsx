                                ...
                                <div className="col">
                                    <div className="form-group">
                                        <label>
                                            ...
                                            <textarea
                                                value={description}
                                                placeholder="Pasta carbonara is one of those simple dinners we should all know how to make. It’s the perfect go-to for a busy weeknight, and it’s also a dish fit for the weekend or even to serve to guests."
                                                name="Descriptions"
                                    ...
                                    <div className="form-group">
                                        <label>
                                            ...
                                            <textarea
                                                ...
                                                placeholder="1. Add bacon and 1/2 cup of the water to a large non-stick skillet and bring to a simmer over medium-high heat.       2. Allow to simmer until water evaporates about 6 - 7 minutes, then reduce heat to medium-low and continue to cook until bacon is brown and crisp, about 6 - 8 minutes longer."
                                                name="Directions"
                                                onChange={(e) => setDirections(e.target.value)}
                                            />
                                        </label>
